...
const EXPECTED_SENTINEL_SHA = "17371D931803D6162DCC0EEE4B7188EA1DB02028E489D59C7D501A5EE61CF4C0";
...
const EVIDENCE_DIR = `${ROOT}/deploy/evidence/final-v5`;
const JOURNAL_PATH = `${EVIDENCE_DIR}/V5_DEPLOYMENT_JOURNAL.json`;

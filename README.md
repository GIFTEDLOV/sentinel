...
<p align="center">
  ...
  <a href="deploy/evidence/final-v5/FINAL_V5_DEPLOYMENT.txt">Deployment</a> ·
  <a href="deploy/evidence/final-v5/FINAL_V5_END_TO_END_PROOF.txt">Verification</a> ·
...
| Network | Studio Next |
| Chain ID | `61997` |
| Sentinel | `0xd83b20EcCF5c1Ddd70aD57EF0E25a5200079c4de` |
| ProtectedDemo | `0xDf9635A1E13379b2F7c25166aAE1C29729b3bFDA` |
| Final incident | `incident-e5115f160d64` |
| Incident | `RECOVERED` |
| Target paused | `false` |
...
The final proof is recorded in [`FINAL_V5_END_TO_END_PROOF.txt`](deploy/evidence/final-v5/FINAL_V5_END_TO_END_PROOF.txt), [`FINAL_V5_END_TO_END_PROOF.json`](deploy/evidence/final-v5/FINAL_V5_END_TO_END_PROOF.json), and the public [sentinel-evidence repository](https://github.com/GIFTEDLOV/sentinel-evidence). The deployment context is recorded in [`FINAL_V5_DEPLOYMENT.txt`](deploy/evidence/final-v5/FINAL_V5_DEPLOYMENT.txt).
...
| Incident detail | `/app/incidents/incident-e5115f160d64` | Evidence, consensus, command center, target state, and proof activity |
...
The route smoke covers `/`, `/app`, `/app/protocols`, `/app/protocols/sentinel-demo`, `/app/incidents`, `/app/incidents/new`, `/app/incidents/incident-e5115f160d64`, `/app/activity`, `/transparency`, and `/developer`.
...
Open `/app/incidents/incident-e5115f160d64`.
...
Confirm the protected target reports `remediated: true` and compare the remediation record with `FINAL_V5_END_TO_END_PROOF.txt`.
...
Review [`deploy/evidence/final-v5/FINAL_V5_DEPLOYMENT.txt`](deploy/evidence/final-v5/FINAL_V5_DEPLOYMENT.txt), [`FINAL_V5_END_TO_END_PROOF.txt`](deploy/evidence/final-v5/FINAL_V5_END_TO_END_PROOF.txt), [`FINAL_V5_END_TO_END_PROOF.json`](deploy/evidence/final-v5/FINAL_V5_END_TO_END_PROOF.json), and [`LOST_RUN_RECONSTRUCTION.txt`](deploy/evidence/final-v5/LOST_RUN_RECONSTRUCTION.txt). The same records are published in the [public evidence repository](https://github.com/GIFTEDLOV/sentinel-evidence).
